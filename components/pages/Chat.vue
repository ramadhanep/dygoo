                ...
                <div class="p-3 px-4">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="font-size-16 mt-0 mb-1"><a href="#" class="text-dark">Marcus <i class="mdi mdi-circle text-success align-middle font-size-10 ml-1"></i></a></h5>
                ...
                <div class="card">
                    ...
                    <div class="px-lg-2">
                        <div class="chat-conversation p-3">
                            <ul class="list-unstyled mb-0" data-simplebar style="max-height: 455px;">
                                    ...
                                    <div class="conversation-list">
                                        <div class="ctext-wrap">
                                            <div class="ctext-wrap-content">
                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-dark">John Howard</a> <span class="d-inline-block font-size-12 text-muted ml-2">10:00</span></h5>
                                                <p class="mb-0">
                                ...
                                <li class="right">
                                    <div class="conversation-list">
                                        <div class="ctext-wrap">
                                            <div class="ctext-wrap-content">
                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-dark">Marcus</a> <span class="d-inline-block font-size-12 text-muted ml-2">10:02</span></h5>
                                                <p class="mb-0">
                                                    Good morning everyone !
                                                </p>
                                            </div>
                                ...
                                <li>
                                    <div class="conversation-list">
                                        <div class="ctext-wrap">
                                            <div class="ctext-wrap-content">
                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-dark">Galen Rizo</a> <span class="d-inline-block font-size-12 text-muted ml-2">10:04</span></h5>
                                                <p class="mb-0">
                                                    Hello!
                                                </p>
                                            </div>
                                ...
                                <li>
                                    <div class="conversation-list">
                                        <div class="ctext-wrap">
                                            <div class="ctext-wrap-content">
                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-dark">John Howard</a> <span class="d-inline-block font-size-12 text-muted ml-2">10:06</span></h5>
                                                <p class="mb-0">
